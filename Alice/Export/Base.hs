...
data Prover = Prover {  prName :: String,   prLabl :: String,    -- prover name / identifier
                        prPath :: String,   prArgs :: [String],  -- path to call the prover / comline arguments with which to call
                        prFrmt :: Format,   prSucc :: [String],  -- format that the prover reads / prover's success message
                        prFail :: [String], prUnkn :: [String] } -- provers's failure message / prover's unkown message

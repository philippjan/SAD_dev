...
[ontored on] We have (n + m) + r < (n + m) + p. [/ontored]
      Therefore r divides n or r divides m (by IH).

      Case r divides n.
        We have (n / r) < n.
        Let us prove that p divides (n / r) * m.[ontored on]
            ((n / r) * m) * r = n * m = ((p * k) / r) * r.[/ontored]
